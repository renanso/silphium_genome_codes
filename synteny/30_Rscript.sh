...
R CMD BATCH riparian_test.R

# Need to run a conversion dos2unix before running the script if editing on a windows based system. sbatch: error: Batch script contains DOS line breaks (\r\n) instead of expected UNIX line breaks (\n)
